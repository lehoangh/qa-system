...
lang = {
    ...
    'eu': 'Basque', 'be': 'Belarusian', 'bn': 'Bengali, Bangla',
    'bh': 'Bihari', 'bi': 'Bislama', 'bs': 'Bosnian', 'br': 'Breton',
    'bg': 'Bulgarian', 'my': 'Burmese', 'ca': 'Catalan', 'ch': 'Chamorro',
    ...
    'de': 'German', 'el': 'Greek (modern)', 'gn': 'Guarani',
    'gu': 'Gujarati', 'ht': 'Haitian, Haitian Creole', 'ha': 'Hausa',
    'he': 'Hebrew (modern)', 'hz': 'Herero', 'hi': 'Hindi',
    'ho': 'Hiri Motu', 'hu': 'Hungarian', 'ia': 'Interlingua',
    'id': 'Indonesian', 'ie': 'Interlingue', 'ga': 'Irish', 'ig': 'Igbo',
    'ik': 'Inupiaq', 'io': 'Ido', 'is': 'Icelandic', 'it': 'Italian',
    'iu': 'Inuktitut', 'ja': 'Japanese', 'jv': 'Javanese',
    'kl': 'Kalaallisut, Greenlandic', 'kn': 'Kannada', 'kr': 'Kanuri',
    'ks': 'Kashmiri', 'kk': 'Kazakh', 'km': 'Khmer',
    'ki': 'Kikuyu, Gikuyu', 'rw': 'Kinyarwanda', 'ky': 'Kyrgyz',
    'kv': 'Komi', 'kg': 'Kongo', 'ko': 'Korean', 'ku': 'Kurdish',
    'kj': 'Kwanyama, Kuanyama', 'la': 'Latin',
    'lb': 'Luxembourgish, Letzeburgesch', 'lg': 'Ganda',
    ...
    'mr': 'Marathi (Marathi)', 'mh': 'Marshallese', 'mn': 'Mongolian',
    'na': 'Nauruan', 'nv': 'Navajo, Navaho', 'nd': 'Northern Ndebele',
    'ne': 'Nepali', 'ng': 'Ndonga', 'nb': 'Norwegian Bokmal',
    'nn': 'Norwegian Nynorsk', 'no': 'Norwegian', 'ii': 'Nuosu',
    'nr': 'Southern Ndebele', 'oc': 'Occitan', 'oj': 'Ojibwe, Ojibwa',
    'cu': 'Old Church Slavonic, Church Slavonic, Old Bulgarian',
    'om': 'Oromo', 'or': 'Oriya', 'os': 'Ossetian, Ossetic',
    'pa': '(Eastern) Punjabi', 'pi': 'Pali', 'fa': 'Persian (Farsi)',
    'pl': 'Polish', 'ps': 'Pashto, Pushto', 'pt': 'Portuguese',
    'qu': 'Quechua', 'rm': 'Romansh', 'rn': 'Kirundi', 'ro': 'Romanian',
    'ru': 'Russian', 'sa': 'Sanskrit (Samskrta)', 'sc': 'Sardinian',
    'sd': 'Sindhi', 'se': 'Northern Sami', 'sm': 'Samoan', 'sg': 'Sango',
    'sr': 'Serbian', 'gd': 'Scottish Gaelic, Gaelic', 'sn': 'Shona',
    'si': 'Sinhalese, Sinhala', 'sk': 'Slovak', 'sl': 'Slovene',
    'so': 'Somali', 'st': 'Southern Sotho', 'es': 'Spanish',
    'su': 'Sundanese', 'sw': 'Swahili', 'ss': 'Swati', 'sv': 'Swedish',
    'ta': 'Tamil', 'te': 'Telugu', 'tg': 'Tajik', 'th': 'Thai',
    'ti': 'Tigrinya', 'bo': 'Tibetan Standard, Tibetan, Central',
    'tk': 'Turkmen', 'tl': 'Tagalog', 'tn': 'Tswana',
    'to': 'Tonga (Tonga Islands)', 'tr': 'Turkish', 'ts': 'Tsonga',
    'tt': 'Tatar', 'tw': 'Twi', 'ty': 'Tahitian', 'ug': 'Uyghur',
    'uk': 'Ukrainian', 'ur': 'Urdu', 'uz': 'Uzbek', 've': 'Venda',
    'vi': 'Vietnamese', 'vo': 'Volapük', 'wa': 'Walloon', 'cy': 'Welsh',
